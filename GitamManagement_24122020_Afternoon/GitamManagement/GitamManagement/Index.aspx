                    ...
                    <div class="col-lg-7">
                        <div class="info d-flex">
                            <div class="content">
                                ...
                                <h4 class="mb-5" style="line-height:1.4" >Application for admission to  UG & PG Programs of Architecture, Basic Sciences, Engineering, Humanities, Law, Management, Nursing, Paramedical and Pharmacy offered at GITAM Campuses</h4>
                                <h4 >Fee:</h4>
                                <ul>
                                    ...
                                    <div class="content">
                                        <form method="post" class="form-validate mb-2" id="reg-form-Validate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="tel" pattern="^[6-9][0-9]{9}$" name="mobile" id="Mobile" placeholder="999-999-9999"
                                            ...
                                            <div class="form-group form-check">
                                                ...
                                                <p style="overflow:auto;height:75px;"><small>By clicking the 'Submit' button, 
