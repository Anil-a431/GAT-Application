<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrentEduDetails.aspx.cs" Inherits="GitamManagement.PL.CurrentEduDetails" %>
    ...
    <div id="">
        <div class="row" id="CEQ">
                    ...
                    <div class="form-group label-floating reg_university_id_div UniversityId field-select" style="">
                        <select name="CAmpus" id="CAmpus" class="form-control select-arrow-cust widget_input" data-label="Intrested Campus *" multiple>
                ...
                <!--phase I_Data-->
                  <div class="row Hdn" id="CEQ_Data">
                      ...
                      <button id="navigateHome" class="btn btn-primary">Ok</button>
